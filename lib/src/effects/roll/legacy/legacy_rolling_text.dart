...
import 'legacy_rolling_text_controller.dart';
...
/// also be customized.
class LegacyRollingText extends StatefulWidget {
  ...
  /// Creates a new [LegacyRollingText] with the given parameters.
  const LegacyRollingText({
    super.key,
    required this.text,
  ...
  @override
  State<LegacyRollingText> createState() => _LegacyRollingTextState();
}

class _LegacyRollingTextState extends State<LegacyRollingText> {
  late LegacyRollingTextController rollingTextPainter =
      createRollingTextController();

  late String oldText = widget.text;

  @override
  void didUpdateWidget(covariant LegacyRollingText oldWidget) {
  ...
  LegacyRollingTextController createRollingTextController() =>
